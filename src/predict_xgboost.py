...
FEATURES_FILENAME = 'xgboost_features.pkl' # File with saved feature names
SUBMISSION_FILENAME = 'submission_xgb.csv' # Unique name for predictions file
...
if __name__ == "__main__":
    ...
    print("\nXGBoost prediction script finished.")